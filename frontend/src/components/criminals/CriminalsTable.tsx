                ...
                <TableBody>
                    {criminals.map((criminal) => (
                        <TableRow key={criminal.id} className="cursor-pointer hover:bg-zinc-900/50">
                            ...
                            <TableCell className="text-zinc-400">{criminal.nationality || 'N/A'}</TableCell>
                            <TableCell>{getThreatLevelBadge(criminal.threat_level)}</TableCell>
                            <TableCell>{getLegalStatusBadge(criminal.legal_status)}</TableCell>
                            <TableCell className="text-zinc-400">{criminal.last_known_location || 'Unknown'}</TableCell>
